...
docs/architecture/
├── README.md                           # This file
├── authentication-architecture.md      # User auth & authorization systems
├── data-layer-architecture.md         # Database design & data flow
├── api-design-architecture.md         # REST/GraphQL API patterns
├── frontend-architecture.md           # UI components & state management
├── testing-architecture.md            # Testing strategies & frameworks
├── deployment-architecture.md         # Infrastructure & CI/CD
├── security-architecture.md           # Security patterns & compliance
├── performance-architecture.md        # Performance & scalability design
└── ai-integration-architecture.md     # AI agent integration patterns
```
