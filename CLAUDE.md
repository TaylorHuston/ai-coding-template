...
```bash
/plan --issue AUTH-123
# → Considers past successful authentication implementations
# → Agents selected based on historical effectiveness
...
# → Leverages past architectural decisions and outcomes
# → Suggests patterns that worked in similar contexts
```
